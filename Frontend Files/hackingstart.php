...
<div class="head_c">
            ...
            <div class="left_section_c">
                <Section>
                    ...
                    <div class="heading_c common_c">
                        <p class="main_heading_c">The Complete Ethical Hacking Course: Beginner to Advanced!</p>

                        <p class="secondery_heading_c">Learn how to do ethical hacking, penetration testing,
                             web testing, and wifi hacking using kali linux!
                    ...
                    <div class="reating_c common_c">
                        ...
                        <div class="second_reating_c">
                            ...
                            <div>
                                <p>32,342 enrolled on this course</p>
                            </div>
                        </div>
            ...
            <div class="right_section_div">
                <div class="right_section_c">
                    <div class="right_img_c">
                        <img class="Image_c" src="../Images/hacking.jpg" alt="">
                    </div>
                    ...
                    <div class="right_details_c">
                        ...
                        <div class="right_button_c">
                            ...
                            <a href="hackingvideo.php">  <button class="second_btn_c"> START</button>  </a>
    ...
    <section class="description_c common_c">
        ...
        <div class="main_description_c">
            ...
            <p class="full_desc_c">Gain the ability to do ethical hacking and penetration testing by 
                taking this course! Get answers from an experienced IT expert to every single question 
                you have related to the learning you do in this course including installing Kali Linux,
                using VirtualBox, basics of Linux, Tor, Proxychains, VPN, Macchanger, Nmap, cracking
                wifi, aircrack, DoS attacks, SLL strip, known vulnerabilities, SQL injections,
                cracking Linux passwords, and more topics that are added every month!</div> 
                <div>If you are like me, you are reading more now because you want to know for sure whether
                this course is worth taking before you invest your money and time in it. More than10,000
                people have already completed the process of deciding to take this course and I hope
                sharing a few of their experiences can prove useful for you here. Here are what three
                recent students had to say in the reviews in their own words.</div>
            </p>
        ...
        <div class="flex_c">
            <div class="learn_flex_c">
                ...
                <div class="first_flex_c">
                    ...
                    <p>Answers to every single question you have about ethical hacking and
                         penetration testing from an experienced IT professional!</p>
                </div>
                <div class="first_flex_c">
                    <i class="fa-regular fa-circle-check"></i>
                    <p>A guide to using these skills to get a better job and make money
                         online as a freelancer.</p>
                </div>
                <div class="first_flex_c">
                    <i class="fa-regular fa-circle-check"></i>
                    <p>A complete tutorial explaining how to build a virtual hacking
                         environment, attack networks, and break passwords.</p>
                </div>
            ...
            <div class="second_flex_c">
                ...
                <div class="first_flex_c">
                    <i class="fa-regular fa-circle-check"></i>
                    <p>Step by step instructions for insulation VirtualBox and creating 
                        your virtual environment on Windows, Mac, and Linux.</p>
                </div>
    ...
    <div class="heading_req_c common_c">
        <h2>Requirements</h2>
        <ul class="list_req_c">
            <li class="first_list_req">Reliable and fast internet connection.</li>
            <li class="first_list_req">Wireless networking card.</li>
         </ul>
    </div>
                ...
                <label for="first">
                    <div class="course_content_1 content-color5">
                        <div class="course_1_left">
                            ...
                            <p class="head_course_1">Introduction to Ethical Hacking. What is it in detail?</p>
                        </div>
                ...
                <div class="contents">
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            ...
                            <p> White Hat vs. Grey Hat vs. Black Hat Hacking</p>
                        </div>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p> What are the prerequisites need for this course</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Installing VirtualBox with rpm plus why use a virtual machine.</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Installing VirtualBox using the default package manager from repositories.</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
            ...
            <li>
                ...
                <label for="second">
                    <div class="course_content_1 content-color1">
                        <div class="course_1_left">
                            <i class="fa-solid fa-chevron-down"></i>
                            <p class="head_course_1">Build your hacking environment</p>
                        </div>
                        <div class="course_1_right">
                ...
                <div class="contents">
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Installing VirtualBox in a Windows 8.1 environment</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Kali Linux installation after it is running and getting starting using it.</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Installing VirtualBox Guest Additions</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
            ...
            <li>
                ...
                <label for="third">
                    <div class="course_content_1 content-color2">
                        <div class="course_1_left">
                            <i class="fa-solid fa-chevron-down"></i>
                            <p class="head_course_1">Installing VirtualBox </p>
                        </div>
                        <div class="course_1_right">
                ...
                <div class="contents">
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Setting up Kali Linux with VirtualBox part 1
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Setting up Kali Linux with VirtualBox part 2
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Setting up Kali Linux with VirtualBox part 3
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Kali Linux Live USB on a MacBook Pro part 2 ( OPTIONAL )
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Kali Linux Live USB on a MacBook Pro part 3 ( OPTIONAL )
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
            ...
            <li>
                ...
                <label for="fourth">
                    <div class="course_content_1 content-color3">
                        <div class="course_1_left">
                            <i class="fa-solid fa-chevron-down"></i>
                            <p class="head_course_1">How to create a bootable USB of Kali with persistent storage  4 GB </p>
                        </div>
                        <div class="course_1_right">
                ...
                <div class="contents">
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>How to create a bootable USB of Kali with persistent storage  4 GB part 1</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>How to create a bootable USB of Kali with persistent storage  4 GB part 2 </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>How to create a bootable USB of Kali with persistent storage  4 GB part 3</p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                            <a href="#">5 question</a> -->
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>How to create a bootable USB of Kali with persistent storage > 4 GB part 4
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p> Kali Sana virtual machine installation
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>How to install VBox GuestAdditions in Kali Sana
            ...
            <li>
                ...
                <label for="fifth">
                    <div class="course_content_1 content-color4">
                        <div class="course_1_left">
                            <i class="fa-solid fa-chevron-down"></i>
                            <p class="head_course_1">Introduction to the Linux terminal.</p>
                        </div>
                        <div class="course_1_right">
                ...
                <div class="contents">
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>Linux Command-Line Interface (CLI) basics.
                    ...
                    <div class="main_cont_1">
                        <div class="cont_det_1">
                            <i class="fa-regular fa-square-caret-right"></i>
                            <p>The Linux CLI explained in greater detail to give you a good understanding.
                            </p>
                        </div>
                        <div class="cont_link_1">
                            <!-- <a href="#">Preview</a>
    ...
    <div class="instructor_c common_c">
        ...
        <div class="img_inst_c">
            ...
            <div class="info_inst_c">
                <p class="name_c">Shreyas Saksena</p>
                <p class="sale_c">IT Expert</p>
        ...
        <p class="p_inst_c"></p>Strongly motivated young IT expert, Linux enthusiast with a passion 
        for troubleshooting network related problems. With an exceptional eye for details and
         a sense of urgency when it comes down to problem solving</p><br>

        <p class="p_inst_c">I do not sleep much, but that is not only because I work hard, rather instead it is
            because I enjoy this line of work,
            it is extremely rewarding in every way that matters</p>
    </div>
    ...
    <section class="review_section_c common_c">
        ...
        <div class="review_first_c">
            ...
            <div class="review_det">
                <p class="review_ali">John Maina M.<span>9 Days ago</span></p>
                <p class="review_LMS">The best course ever</p>
                <p class="review_para">Way, way too much time is spent teaching basic of Unix, Virtualbox,
                     and C++ programming instead of hacking techniques. It is clear the instructor is
                      more comfortable teaching these basics than the hacking</p>
        ...
        <div class="review_first_c">
            ...
            <div class="review_det">
                <p class="review_ali">Martin M. <span>3 Days ago</span></p>
                <p class="review_LMS">The course ever seen tood Good</p>
                <p class="review_para">This course i have chosen is a very fine & detailed course,
                     The tutors try to reach out to the student with plenty of help. I will at some
                      point take another course with the tutors involved as they have come up trumps 
                      for me personally. At this time i do have other courses on udemy.com to complete. 
                      as ermin says. for now "i bid you fair-well", on-til the next time. and a BIG
                       Thanks to you all 
                </p>
